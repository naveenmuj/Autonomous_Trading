...
class TrainingPipeline:
    ...
    def get_default_models(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise    def train_models(self, data: Optional[pd.DataFrame] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return self.get_default_models()def _train_lstm_model(self, X: np.ndarray, y: np.ndarray) -> Any:
        ...
        try:
            ...
            return None    def _train_ffnn_model(self, X: np.ndarray, y: np.ndarray) -> Any:
